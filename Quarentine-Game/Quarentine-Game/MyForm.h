...
namespace QuarentineGame {
	...
	public:
		...
		MyForm(int vv, int vt, String^ vd, String^ vu, int vm)
		{
			valor_vidas = vv;
...
#pragma region Windows Form Designer generated code
		   void InitializeComponent(void)
		   {
			   ...
			   this->groupBox1->Size = System::Drawing::Size(601, 63);
			   ...
			   this->label_enviado->Location = System::Drawing::Point(236, 35);
			   ...
			   this->label_Dificultad->Location = System::Drawing::Point(393, 16);
			   ...
			   this->label_Vulnerabilidad->Location = System::Drawing::Point(468, 35);
